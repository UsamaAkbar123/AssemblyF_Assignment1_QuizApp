...
class _QuizQuestionState extends State<QuizQuestion> {
  ...
  bool showNextOrSubmitButton = false;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          showNextOrSubmitButton == false && MediaQuery.of(context).orientation == Orientation.landscape
              ? Align(
                        ...
                        showDialog(
                          ...
                          builder: (context) {
                            return AlertDialog(
                              ...
                              content: const Text('Then Click on Next Button'),
                              actions: [
                                TextButton(
                                  child: const Text("OK"),
                                  onPressed: () {
                  ...
                  child: InkWell(
                    onTap: () {
                      if (noOfClick1 == filter_question_list.length) {
                        int result = Provider.of<QuestionController>(context,
                                listen: false)
                            .copyCorrectAns;
                        ...
                        showDialog(
                            ...
                            builder: (context) {
                              return AlertDialog(
                                ...
                                content:
                                    const Text('Press Ok for Continue Quiz'),
                                actions: [
                                  TextButton(
                                    child: const Text("OK"),
                                    onPressed: () {
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        width: MediaQuery.of(context).orientation ==
                            ...
                            : size.width * 0.5,
                        padding:
                            const EdgeInsets.only(left: 0, right: 25, top: 10),
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index1) {
                            return Container(
                              ...
                              height: 50.0,
                              // width: MediaQuery.of(context).orientation == Orientation.portrait ? double.infinity : size.width * 0.2,
                              decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(20.0),
                                      ...
                                      setState(
                                        () {
                                          if (radioValue == -1) {
                                            ...
                                            showButton = true;
                                            radioValue = newValue!;
                                            Provider.of<QuestionController>(
                                                    context,
                                                    listen: false)
                                                .finalScore(
                                              filter_question_list[index]
